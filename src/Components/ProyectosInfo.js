...
export const Datos = [
  ...
  },
  {
    ...
    link: "https://github.com/alex03av/clima-react",
  },
  {
    id: 7,
    img: "7.png",
    title: "Contador En J's",
    description:
      "A continuación, se muestra un ejemplo simple de un contador estático que utiliza un diseño HTML simple. En este ejemplo, el valor del contador lo establece el usuario, en cada click nos suma un valor. Hay muchas situaciones en las que los contadores son útiles, este contador en particular fue desarrollado en JAVASCRIPT, HTML5, CSS.",
    link: "https://codepen.io/alex03av/full/abjpGvO",
  },
  {
    id: 8,
    img: "11.png",
    title: "Calculadora Basica En J's",
    description:
      "La calculadora básica es desarrollada con las tres tecnologías del FRONT-END fundamentales las cuales son HTM5, CSS y JAVASCRIPT, la entrada te permite ejecutar las cuatro operaciones básicas que son: sumar, restar, multiplicar y dividir, adicionalmente incluye un botón para resetear los resultados en caso de querer realizar una nueva operación..",
    link: "https://codepen.io/alex03av/full/gOjgzPX",
  },
  {
    id: 9,
    img: "8.png",
  ...
  },
  {
    id: 10,
    img: "9.png",
    title: "Palindrome Word Checker En J's",
    description:
      "El siguiente proyecto le permite verificar si una palabra es palíndroma o no, mediante un input, devuelve dos posibles opciones, es una palabra palíndroma, no es una palabra palíndroma, pero si te preguntas que es un palíndromo: es una palabra o frase en la que las letras están dispuestas de manera que se pueden leer en cualquier dirección. Es decir, suena igual si lo lees de izquierda a derecha o de derecha a izquierda.",
    link: "https://codepen.io/alex03av/full/jOpyZQy",
  },
];
